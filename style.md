...
```md
<type>(<jira-ticket>...[scope]): <subject>
...
1. 标题行: 描述主要修改类型, jira 单号和内容 _(必填)_
2. 主题内容: 描述为什么修改, 做了什么样的修改, 以及开发的思路等等 _(可选)_
3. 页脚注释: 放 Breaking Changes 或 Closed Issues _(可选)_
...
JIRA 单号, **必须有**, 可以有多个. `feat(ABC-100 ABC-103)`
...
```js
// 示例1
fix(ABC-100 global): 修复checkbox不能复选的问题
...
```js
chore(ABC-100): 将表格中的查看详情改为详情
```

## 参考资料

- [woai3c](https://github.com/woai3c/Front-end-articles/blob/master/git%20commit%20style.md)
